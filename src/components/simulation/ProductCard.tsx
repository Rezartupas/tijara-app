...
export default function ProductCard({ product }: { product: Product }) {
  return (
    <article className="flex gap-5 rounded-2xl border border-gray-100 bg-white p-5 shadow-soft transition-all hover:shadow-md">
      <figure className="relative h-28 w-28 shrink-0 overflow-hidden rounded-xl border border-gray-100">
        <img
